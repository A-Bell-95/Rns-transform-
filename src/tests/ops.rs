...
fn test_sub() {
    let a = Rns::<18>::new(192);
    let b = Rns::<18>::new(18);
    assert_eq!(a - b, Rns::new(174));

    let a = Rns::<18>::new(1);
    let b = Rns::<18>::new(1);
    assert_eq!(a - b, Rns::new(0));

    let a = Rns::<18>::new(10100000);
    let b = Rns::<18>::new(100000);
    assert_eq!(a - b, Rns::new(10000000));
}
...
fn test_sub_random() {
    ...
    for _ in 0..100 {
        ...
        let expected = a as u64 - b as u64;
        assert_eq!(res.into_u64(), expected);
        assert_eq!(res, Rns::new(expected));
    }
}
...
fn test_sub_assign() {
    ...
    let b = Rns::<18>::new(18);
    a -= b;
    assert_eq!(a, Rns::new(174));

    let mut a = Rns::<18>::new(1);
    let b = Rns::<18>::new(1);
    a -= b;
    assert_eq!(a, Rns::new(0));

    let mut a = Rns::<18>::new(10100000);
    let b = Rns::<18>::new(10000000);
    a -= b;
    assert_eq!(a, Rns::new(100000));
}
